...
class LeaveService:
    ...
    async def approve_leave(
        ...
        If approved, automatically mark attendance as 'Excused' for all sessions in the date range.
        """
        ...
        # If approved, auto-mark attendance as excused
        if status == "APPROVED":
    ...
    async def _mark_excused_attendance(self, leave: LeaveRequest):
        """
        Automatically mark attendance as 'Excused' for all sessions during the leave period.
        """
        # Get all sessions that fall within the leave date range
        ...
        # Filter sessions to only those in student's enrolled classes
        ...
        for session in relevant_sessions:
            ...
            if existing:
                ...
                # Create new excused attendance record
    ...
    async def check_leave_conflict(
        ...
        """
        Check if there's an existing approved leave that overlaps with the requested dates.
        """
