...
class AttendanceRepository:
    ...
    async def get_by_id(self, attendance_id: str) -> Optional[Attendance]:
        ...
        return await db.attendance.find_unique(where={"id": attendance_id})
    ...
    async def get_flagged(self) -> List[Attendance]:
        """Return all flagged attendance records with student, session, class, and subject data."""
    ...
    async def get_by_student_in_date_range(
        self, student_id: str, start_date, end_date
    ) -> List[Attendance]:
