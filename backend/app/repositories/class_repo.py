...
class ClassRepository:
    ...
    async def create(self, name: str, subject: str, teacher_id: str) -> AcademicClass:
        return await db.academicclass.create(data={"name": name, "subject": subject, "teacherId": teacher_id})

    async def update_teacher(self, class_id: str, teacher_id: str) -> AcademicClass:
        return await db.academicclass.update(where={"id": class_id}, data={"teacherId": teacher_id})
