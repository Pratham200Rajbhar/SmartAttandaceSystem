...
class StudentCreate(BaseModel):
    """Fields required to create a new student account and profile."""
...
class StudentUpdate(BaseModel):
    """Payload for updating a student record."""
...
class StudentResponse(BaseModel):
    """Public-facing representation of a student record."""
...
class StudentAttendanceItem(BaseModel):
    """A single attendance record in the student's history."""
...
class StudentAttendanceHistoryResponse(BaseModel):
    """Aggregated attendance history for a student."""
...
class StudentClassResponse(BaseModel):
    """A class the student is enrolled in."""
    class_id: str = Field(..., description="Class UUID")
    class_name: str = Field(..., description="Class name")
    subject: str = Field(..., description="Subject name")
