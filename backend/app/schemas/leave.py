"""
Pydantic schemas for leave request management.
"""
...
class LeaveRequestResponse(BaseModel):
    """Response schema for leave request details."""
    id: str
    student_id: str
    student_name: str
...
class LeaveRequestApprove(BaseModel):
    """Request schema for approving/rejecting a leave request."""
...
class LeaveRequestListResponse(BaseModel):
    """Response schema for list of leave requests."""
